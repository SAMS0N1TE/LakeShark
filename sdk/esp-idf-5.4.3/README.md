...
LakeShark uses ESP-IDF 5.4.3 plus two recorded patches:
...
commit. `provenance.json` records the base, commit and hashes; the two patch
files provide the readable diffs. Run the usual ESP-IDF export script before
