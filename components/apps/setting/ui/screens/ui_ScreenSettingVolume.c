...
lv_obj_clear_flag( ui_PanelScreenSettingVolumeSwitch, LV_OBJ_FLAG_SCROLLABLE );
...
lv_obj_set_width( ui_ImagePanelScreenSettingVolumeSwitch, LV_SIZE_CONTENT);
lv_obj_set_height( ui_ImagePanelScreenSettingVolumeSwitch, LV_SIZE_CONTENT);
...
lv_obj_add_flag( ui_ImagePanelScreenSettingVolumeSwitch, LV_OBJ_FLAG_ADV_HITTEST );
lv_obj_clear_flag( ui_ImagePanelScreenSettingVolumeSwitch, LV_OBJ_FLAG_SCROLLABLE );

ui_LabelPanelScreenSettingVolumeSwitch = lv_label_create(ui_PanelScreenSettingVolumeSwitch);
lv_obj_set_width( ui_LabelPanelScreenSettingVolumeSwitch, LV_SIZE_CONTENT);
lv_obj_set_height( ui_LabelPanelScreenSettingVolumeSwitch, LV_SIZE_CONTENT);
...
lv_obj_set_height( ui_PanelScreenSettingVolumeList, LV_SIZE_CONTENT);
...
lv_obj_add_flag( ui_PanelScreenSettingVolumeList, LV_OBJ_FLAG_HIDDEN );
...
lv_obj_add_flag( ui_SpinnerScreenSettingVolume, LV_OBJ_FLAG_HIDDEN );
lv_obj_clear_flag( ui_SpinnerScreenSettingVolume, LV_OBJ_FLAG_CLICKABLE );
...
lv_obj_add_flag( ui_ButtonScreenSettingVolumeReturn, LV_OBJ_FLAG_SCROLL_ON_FOCUS );
lv_obj_clear_flag( ui_ButtonScreenSettingVolumeReturn, LV_OBJ_FLAG_SCROLLABLE );
...
lv_obj_set_width( ui_ImageScreenSettingVolumeReturn, LV_SIZE_CONTENT);
lv_obj_set_height( ui_ImageScreenSettingVolumeReturn, LV_SIZE_CONTENT);
lv_obj_set_align( ui_ImageScreenSettingVolumeReturn, LV_ALIGN_CENTER );
lv_obj_add_flag( ui_ImageScreenSettingVolumeReturn, LV_OBJ_FLAG_ADV_HITTEST );
lv_obj_clear_flag( ui_ImageScreenSettingVolumeReturn, LV_OBJ_FLAG_SCROLLABLE );
