...
lv_obj_clear_flag( ui_PanelScreenSettingBLESwitch, LV_OBJ_FLAG_SCROLLABLE );
...
lv_obj_set_width( ui_ImagePanelScreenSettingBLESwitch, LV_SIZE_CONTENT);
lv_obj_set_height( ui_ImagePanelScreenSettingBLESwitch, LV_SIZE_CONTENT);
...
lv_obj_add_flag( ui_ImagePanelScreenSettingBLESwitch, LV_OBJ_FLAG_ADV_HITTEST );
lv_obj_clear_flag( ui_ImagePanelScreenSettingBLESwitch, LV_OBJ_FLAG_SCROLLABLE );

ui_LabelPanelScreenSettingBLESwitch = lv_label_create(ui_PanelScreenSettingBLESwitch);
lv_obj_set_width( ui_LabelPanelScreenSettingBLESwitch, LV_SIZE_CONTENT);
lv_obj_set_height( ui_LabelPanelScreenSettingBLESwitch, LV_SIZE_CONTENT);
...
lv_obj_set_height( ui_PanelScreenSettingBLEList, LV_SIZE_CONTENT);
...
lv_obj_clear_flag( ui_SpinnerScreenSettingBLE, LV_OBJ_FLAG_CLICKABLE );
...
lv_obj_add_flag( ui_ButtonScreenSettingBLEReturn, LV_OBJ_FLAG_SCROLL_ON_FOCUS );
lv_obj_clear_flag( ui_ButtonScreenSettingBLEReturn, LV_OBJ_FLAG_SCROLLABLE );
...
lv_obj_set_width( ui_ImageScreenSettingBLEReturn, LV_SIZE_CONTENT);
lv_obj_set_height( ui_ImageScreenSettingBLEReturn, LV_SIZE_CONTENT);
lv_obj_set_align( ui_ImageScreenSettingBLEReturn, LV_ALIGN_CENTER );
lv_obj_add_flag( ui_ImageScreenSettingBLEReturn, LV_OBJ_FLAG_ADV_HITTEST );
lv_obj_clear_flag( ui_ImageScreenSettingBLEReturn, LV_OBJ_FLAG_SCROLLABLE );
