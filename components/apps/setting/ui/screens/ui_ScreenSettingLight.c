...
lv_obj_clear_flag( ui_PanelScreenSettingLightSwitch, LV_OBJ_FLAG_SCROLLABLE );
...
lv_obj_set_width( ui_ImagePanelScreenSettingLightSwitch, LV_SIZE_CONTENT);
lv_obj_set_height( ui_ImagePanelScreenSettingLightSwitch, LV_SIZE_CONTENT);
...
lv_obj_add_flag( ui_ImagePanelScreenSettingLightSwitch, LV_OBJ_FLAG_ADV_HITTEST );
lv_obj_clear_flag( ui_ImagePanelScreenSettingLightSwitch, LV_OBJ_FLAG_SCROLLABLE );

ui_LabelPanelScreenSettingLightSwitch = lv_label_create(ui_PanelScreenSettingLightSwitch);
lv_obj_set_width( ui_LabelPanelScreenSettingLightSwitch, LV_SIZE_CONTENT);
lv_obj_set_height( ui_LabelPanelScreenSettingLightSwitch, LV_SIZE_CONTENT);
...
lv_obj_set_width( ui_SliderPanelScreenSettingLightSwitch1, 270);
...
lv_obj_set_height( ui_PanelScreenSettingLightList, LV_SIZE_CONTENT);
...
lv_obj_add_flag( ui_PanelScreenSettingLightList, LV_OBJ_FLAG_HIDDEN );
...
lv_obj_add_flag( ui_SpinnerScreenSettingLight, LV_OBJ_FLAG_HIDDEN );
lv_obj_clear_flag( ui_SpinnerScreenSettingLight, LV_OBJ_FLAG_CLICKABLE );
...
lv_obj_add_flag( ui_ButtonScreenSettingLightReturn, LV_OBJ_FLAG_SCROLL_ON_FOCUS );
lv_obj_clear_flag( ui_ButtonScreenSettingLightReturn, LV_OBJ_FLAG_SCROLLABLE );
...
lv_obj_set_width( ui_ImageScreenSettingLightReturn, LV_SIZE_CONTENT);
lv_obj_set_height( ui_ImageScreenSettingLightReturn, LV_SIZE_CONTENT);
lv_obj_set_align( ui_ImageScreenSettingLightReturn, LV_ALIGN_CENTER );
lv_obj_add_flag( ui_ImageScreenSettingLightReturn, LV_OBJ_FLAG_ADV_HITTEST );
lv_obj_clear_flag( ui_ImageScreenSettingLightReturn, LV_OBJ_FLAG_SCROLLABLE );
