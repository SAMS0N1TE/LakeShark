...
/* One line above the buttons, carrying the hold rule before the first press and the countdown during one. */
                 ...
                 ls_ui_button_role_t role, action_slot_t *slot, lv_obj_t *hint)
{
    ...
    /* Same reasoning as ls_ui_group_button (): a fixed screen/6 width
