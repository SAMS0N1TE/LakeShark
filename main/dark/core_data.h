...
// esp-brookesia 0.4.2 added its own definition of this macro upstream; we
// intentionally override it for the local 720x720 stylesheet, so undef first
// to silence the "macro redefined" warning.
#undef ESP_BROOKESIA_PHONE_DEFAULT_DARK_CORE_DATA
